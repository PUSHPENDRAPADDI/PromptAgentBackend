...
import './MainChatgptScreen.css';
import { FaMicrophone, FaCopy, FaPaperPlane } from 'react-icons/fa';
import ModalForPrompt from './ModalForPrompt';
import { AgentContext } from '../context/AgentContext';
import { TerminalOutput } from "react-terminal-ui";

const MainChatgptScreen = () => {
    ...
    }, [state.promptTemplate, input, setState]);
            ...
            <div className="chat-content">
                <div className="chat-box">
                    {state.chatConversation.length > 0 ? (
                        ...
                        <div className="chat-empty"><h1 className='text-color'>What can I help with ?</h1></div>
                    )}
                </div>
                <div className="input-box">
                    ...
                    />
                    <FaPaperPlane size={24} onClick={handleSendMessage} color="#0078d4" />
                </div>
            </div>
            <ModalForPrompt
                show={isOpenModal}
...
export default MainChatgptScreen;
